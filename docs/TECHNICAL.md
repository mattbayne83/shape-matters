...
- **Torque model replaced old variance-based agility** — see [TORQUE_MODEL.md](TORQUE_MODEL.md)
...
- **Autonomy pillar uses DCI, NOT oscillator** — damped harmonic oscillator was removed. Autonomy score = DCI × depth discount (log(3)/log(L)). DCI slider (0-100) is a separate input from fidelity, breaking the prior Fidelity-Agility redundancy. See [TORQUE_MODEL.md](TORQUE_MODEL.md) and council-transcript-20260407-agility.md.
