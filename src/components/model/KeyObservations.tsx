  ...
  return (
    <div className="bg-white border border-stone-200 rounded-xl p-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div>
          <div className="text-[11px] text-stone-500 mb-1">Flattest Structure</div>
        ...
        <div>
          <div className="text-[11px] text-stone-500 mb-1">Best Signal to Top</div>
        ...
        <div>
          <div className="text-[11px] text-stone-500 mb-1">Leanest Management</div>
        ...
        {analysis.mostAgile && (
          <div>
            <div className="text-[11px] text-stone-500 mb-1">Highest Agility</div>
      ...
      <div className="mt-4 text-xs text-stone-500 leading-relaxed border-t border-stone-200 pt-3">
